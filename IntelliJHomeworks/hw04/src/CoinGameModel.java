...
public interface CoinGameModel {
  ...
  /**
   * Adds all names in to the play order after specified number of turns
   *
   * @param numOfTurns how many turns before the first player in names goes
   *                   If numOfTurns = 0, the players get put at the end
   * @param names String names of players
   * @throws IllegalArgumentException if numOfTurns is negative or too many
   */
  void addPlayers(int numOfTurns, String... names);
