...
public abstract class AbstractDurationTest {
  ...
  public void formatExample3() {
      hms(4, 5, 17).format("%r:%M:%S");
    }

  @Test
  // No symbols
  public void formatExample4() {
    assertEquals("Nothing gets replaced.",
            hms(4, 5, 17).format("Nothing gets replaced."));
    }
