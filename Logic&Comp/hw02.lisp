...
#|(defunc min (n1 n2)
  :input-contract (and (rationalp n1) (rationalp n2))
  :output-contract (rationalp (min n1 n2))
...
(defunc minimum (l)
  :input-contract (and (lorp l) (not (equal l nil)))
  :output-contract (rationalp (minimum l))
  (if (equal nil (rest l)) (first l)
...
(defunc rem (x y)
  :input-contract (and (natp x) (integerp y))
...
(check= (nat/ 11 2) 5)
(check= (nat/ 8 8) 1)
(check= (nat/ 3 5) 0)#|ACL2s-ToDo-Line|#
